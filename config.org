...
* Installation
** Quick Installation
=git clone https://github.com/mraphael/UncleDavesEmacs ~/.emacs.d=
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun mraphael/launch-discord ()
    (interactive)
    (exwm-async-run "discord"))

  (defun mraphael/launch-browser ()
    (interactive)
    (exwm-async-run "firefox"))

  (defun mraphael/lock-screen ()
    (interactive)
    (exwm-async-run "slock"))

  (defun mraphael/shutdown ()
    (interactive)
...
#+BEGIN_SRC emacs-lisp
  (global-set-key (kbd "s-d") 'mraphael/launch-discord)
  (global-set-key (kbd "<s-tab>") 'mraphael/launch-browser)
  (global-set-key (kbd "<s-f2>") 'mraphael/lock-screen)
  (global-set-key (kbd "<XF86PowerOff>") 'mraphael/shutdown)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (defun mraphael/take-screenshot ()
  ...
  (global-set-key (kbd "<print>") 'mraphael/take-screenshot)
#+END_SRC

*** Screenshotting a region
#+BEGIN_SRC emacs-lisp
  (defun mraphael/take-screenshot-region ()
  ...
  (global-set-key (kbd "<Scroll_Lock>") 'mraphael/take-screenshot-region)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package helm
    ...
    ("M-x" . 'helm-M-x)
    :config
    (defun mraphael/helm-hide-minibuffer ()
    ...
    (add-hook 'helm-minibuffer-set-up-hook 'mraphael/helm-hide-minibuffer)
...
#+BEGIN_SRC emacs-lisp
  (defun mraphael/kill-inner-word ()
    "Kills the entire word your cursor is in. Equivalent to 'ciw' in vim."
    (interactive)
    (forward-char 1)
    (backward-word)
    (kill-word 1))
  (global-set-key (kbd "C-c w k") 'mraphael/kill-inner-word)
#+END_SRC

** Improved copy-word
And again, the same as above but we make sure to not delete the source word.
#+BEGIN_SRC emacs-lisp
  (defun mraphael/copy-whole-word ()
    (interactive)
    (save-excursion
      (forward-char 1)
      (backward-word)
      (kill-word 1)
      (yank)))
  (global-set-key (kbd "C-c w c") 'mraphael/copy-whole-word)
#+END_SRC

** Copy a line
Regardless of where your cursor is, this quickly copies a line.
#+BEGIN_SRC emacs-lisp
  (defun mraphael/copy-whole-line ()
    ...
    (save-excursion
      (kill-new
       (buffer-substring
        (point-at-bol)
        (point-at-eol)))))
  (global-set-key (kbd "C-c l c") 'mraphael/copy-whole-line)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (setq erc-server-history-list '("irc.libera.chat:6697"
                                  "localhost"))
